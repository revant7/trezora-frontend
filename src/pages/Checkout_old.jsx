    ...
    const CompleteOrder = async () => {
        try {
            ...
            if (!apiData?.address?.address) {
                setError("Please update your complete address before placing the order.");
                return;
            }
            ...
            // Format order data to match backend requirements
            const orderData = {
                cart_items: cartData.map(item => ({
                    product_id: item.prod_unique_id,
                ...
                <div className="bg-gray-200 p-5 text-black w-[430px] h-[400px] rounded-lg mx-auto">
                    ...
                    <div className="bg-gray-200 p-5 text-black w-[400px] rounded-lg">
                        ...
                        <div className='flex justify-center py-[30px]'>
                            <button
                                className={`w-[450px] h-[40px] rounded-[300px] text-xl font-bold ${loading || apiData === null || !apiData?.address?.address || !paymentMethod
